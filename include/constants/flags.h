...
#define FLAG_INFINITE_REPEL  0x20 // Infinite Repel Flag
#define FLAG_NUZLOCKE_ITEMS  0x21 // Allow Giving Nuzlocke Items Flag
...
#define FLAG_HIDDEN_ITEM_ROUTE_104_HEART_SCALE               (FLAG_HIDDEN_ITEMS_START + 0x58)  // Not Hidden
...
#define FLAG_HIDDEN_ITEM_PETALBURG_CITY_RARE_CANDY           (FLAG_HIDDEN_ITEMS_START + 0x5F)  // Replaced with Potion (cheaters)
...
// Item Ball Flags
#define FLAG_ITEM_ROUTE_102_POTION                                  0x3E8  // Actually a Big Root
...
#define FLAG_ITEM_ROUTE_104_POKE_BALL                               0x421 // Changed to Sitrus Berry
...
#define FLAG_DEFEATED_MARVIN_BOSS                   (SYSTEM_FLAGS + 0x85) // Flag for the Marvin boss battle (1st Boss Battle)
