...
#define VAR_GIVE_NUZLOCKE_ITEMS                          0x40F7 // Should the player receive Nuzlocke items? (0 = No, 1 = Yes)
#define VAR_GIVE_LITTLEROOT_SUPERROD                     0x40F8 // Should we give the player the Super Rod in Littleroot Town? (0 = No, 1 = Yes)
