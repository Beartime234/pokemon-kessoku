...
static u8 ChooseWildMonIndex_Fishing(u8 rod)
{
    ...
    case OLD_ROD:
        ...
        wildMonIndex = 0; // Pokemon Kessoku Should not have access to the old rod but if somehow they do - leave in for merge conflicts
        break;
    case GOOD_ROD:
        ...
        wildMonIndex = 2; // Pokemon Kessoku Should not have access to the good rod but if somehow they do - leave in for merge conflicts
        break;
    // Custom Super Rod Code for Pokemon Kessoku
    case SUPER_ROD:
